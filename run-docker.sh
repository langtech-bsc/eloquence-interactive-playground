...
#docker run --name eloquence-ip-dev -d -e GRADIO_SERVER_PORT=8084 -p 8084:8084 -v "$(pwd)"/playground-data/data/:/data eloquence-ip:dev
docker run --name eloquence-ip-dev -it -e GRADIO_SERVER_PORT=8084 -p 8084:8084 -v "$(pwd)"/playground-data/data/:/data eloquence-ip:dev
# --net="host"